...
// AsyncStorage's web implementation shims to `window.localStorage`, which
// doesn't exist during Expo Router's web SSR pass — without this guard,
// Supabase's session-recovery-on-init crashes the server render entirely.
